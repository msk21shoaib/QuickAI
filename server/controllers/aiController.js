...
export const generateImage = async (req, res) => {
  try {
    ...
    if (plan !== "premium") {
      return res.json({
        success: false,
        message: "This feaure is only available for premium users",
      });
    }

    //here we can use a different API for image generation
...
export const removeImageBackground = async (req, res) => {
  try {
    ...
    await sql`INSERT INTO creations (user_id, prompt, content, type) VALUES (${userId}, 'Remove backgrond from image', ${secure_url}, 'image')`;
